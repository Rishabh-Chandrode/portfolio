            ...
            <div className='z-10'>
                ...
                <div className='socials flex flex-row gap-2 items-center' >
                    <Link href={"https://github.com/Rishabh-Chandrode"} >
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 64 64" style={{"fill":"#FFFFFF"}}>
