...
const Skills = () => {
    ...
    const skills = {
        programming: [
            ...
            {
                name: 'C++',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="35" viewBox="0 0 48 48">
                    <title id="svg-title">CPP/c++ icon</title>
  <desc id="svg-desc">Rishabh Chandrode Skills section Cpp programming language icon</desc>
            ...
            },
            {
                name: 'C',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="35" viewBox="0 0 48 48">
                    <title id="svg-title">C icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section C programming language icon</desc>
            ...
            },
            {
                ...
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 48 48">
                    <title id="svg-title">Python programming language icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section Python programming language icon</desc>
        ...
        web: [
            {
                ...
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                    <title id="svg-title">HTML icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section HTML language icon</desc>
            ...
            },
            {
                name: 'CSS',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                    <title id="svg-title">CSS icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section CSS programming language icon</desc>
            ...
            },
            {
                ...
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
                    <title id="svg-title">JavaScript language icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section JavaScript language icon</desc>
            ...
            {
                name: 'React',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 100 100">
                    <title id="svg-title">React Library icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section React Library icon</desc>
            ...
            },
            {
                name: 'Node.js',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
                    <title id="svg-title">Nodejs icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section Nodejs programming language icon</desc>
            ...
            },
            {
                ...
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50">
                    <title id="svg-title">Express js icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section Expressjs programming language icon</desc>
        ...
        db: [
            {
                name: 'MongoDB',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                    <title id="svg-title">MongoDB icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section MongoDb icon</desc>
            ...
            {
                name: 'MySQL',
                icon: <img width="50" height="50" src="https://img.icons8.com/ios/50/sql.png" alt="sql" />,
                color: '#4479a1'
            }
        ],
        os: [
            {
                name: 'Linux',
                icon: <img width="48" height="48" src="https://img.icons8.com/color/48/linux--v1.png" alt="linux--v1" />,
                color: '#fcc624'
            },
            {
                name: 'Windows',
                icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                    <title id="svg-title">windows operating system icon</title>
                    <desc id="svg-desc">Rishabh Chandrode Skills section windows operating system icon</desc>
        ...
        misc: [
            {
                name: 'Git',
                icon: <img width="48" height="48" src="https://img.icons8.com/color/48/git.png" alt="git" />,
                color: '#f05032'
            },
            {
                name: 'firebase',
                icon: <img width="48" height="48" src="https://img.icons8.com/color/48/000000/firebase.png" alt="firebase" />,
            },
            {
                name: 'Data Structure',
                icon: <img width="48" height="48" src="https://img.icons8.com/color/48/tree-structure.png" alt="tree-structure" />

            },
            {
                name: 'algorithm',
                icon: <img width="40" height="40" src="https://img.icons8.com/3d-fluency/100/rubiks-cube.png" alt="rubiks-cube" />
            }
